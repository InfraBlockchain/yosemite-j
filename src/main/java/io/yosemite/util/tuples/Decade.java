 ...
 * =============================================================================
 */
package io.yosemite.util.tuples;

import java.util.Collection;
import java.util.Iterator;

import io.yosemite.util.tuples.valueintf.IValue0;
import io.yosemite.util.tuples.valueintf.IValue1;
import io.yosemite.util.tuples.valueintf.IValue2;
import io.yosemite.util.tuples.valueintf.IValue3;
import io.yosemite.util.tuples.valueintf.IValue4;
import io.yosemite.util.tuples.valueintf.IValue5;
import io.yosemite.util.tuples.valueintf.IValue6;
import io.yosemite.util.tuples.valueintf.IValue7;
import io.yosemite.util.tuples.valueintf.IValue8;
import io.yosemite.util.tuples.valueintf.IValue9;
