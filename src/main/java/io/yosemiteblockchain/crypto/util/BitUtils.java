package io.yosemiteblockchain.crypto.util;
...
public class BitUtils {
    ...
    public static long uint16ToLong(byte[] buf, int offset) {
        return ((buf[offset++] & 0xFFL)) | ((buf[offset++] & 0xFFL) << 8);
    }

    public static long uint32ToLong(byte[] buf, int offset) {
        return ((buf[offset++] & 0xFFL)) | ((buf[offset++] & 0xFFL) << 8) | ((buf[offset++] & 0xFFL) << 16)
                | ((buf[offset] & 0xFFL) << 24);
    }
    ...
    public static int uint16FromStream(DataInputStream stream) throws IOException {
        return (int) (((stream.read() & 0xFFL)) | ((stream.read() & 0xFFL) << 8));
    }

    public static int uint16FromStreamBE(DataInputStream stream) throws IOException {
        return (int) (((stream.read() & 0xFFL) << 8) | ((stream.read() & 0xFFL)));
    }

    public static int uint32FromStream(DataInputStream stream) throws IOException {
        return (int) (((stream.read() & 0xFFL)) | ((stream.read() & 0xFFL) << 8) | ((stream.read() & 0xFFL) << 16) | ((stream
                .read() & 0xFFL) << 24));
    }

    public static long uint64FromStream(DataInputStream stream) throws IOException {
        return ((stream.read() & 0xFFL)) | ((stream.read() & 0xFFL) << 8) | ((stream.read() & 0xFFL) << 16)
